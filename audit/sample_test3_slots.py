"""Draw the question slots for TEST-3 at random (fixed seed) so that the choice
...
PRODUCT_ATTRS = {'dosage': 9, 'function': 5, 'application': 2, 'source': 3, 'activity': 2, 'enzyme_type': 2, 'storage': 2}
CORPUS_ATTRS = {'allergens': 1, 'gmo': 1, 'irradiation': 1, 'packaging': 1, 'microbiology': 1, 'heavy_metals': 1,
                'moisture': 1, 'aspect': 1, 'manufacturer': 1, 'last_update': 1}
AA_ATTRS = {'aa_dosage_type': 4, 'aa_max': 1, 'aa_conversion': 1, 'aa_mode': 3, 'aa_specs': 2, 'aa_storage': 2,
            'aa_role': 2, 'aa_limits': 1, 'aa_alternatives': 1}
SUB = {
...
MULTI_INTENTS = ['dosage'] * 3 + ['function'] * 2 + ['source', 'storage']
