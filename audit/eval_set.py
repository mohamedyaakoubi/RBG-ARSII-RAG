...
TEST = [
    ...
    Q('T20', 'fr', "Combien de grammes d'acide ascorbique pour 100 kg de farine à 50 ppm ?", [T('AA conversion', AA, r"100kg5g")]),
    ...
    Q('T26', 'fr', "Dosage d'acide ascorbique pour la viennoiserie", [T('AA viennoiserie', AA, r"viennoiserie.{0,15}50-75")]),
